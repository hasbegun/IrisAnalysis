...
#define EYE_CASCADE "parojosG_45x11.xml"

IrisCompare::IrisCompare( QWidget* parent /*= 0*/, Qt::WindowFlags flags /*= 0*/ ) : QMainWindow(parent, flags)
{
    eyeDetection = new EyeDetection("../Cascade/parojosG_45x11.xml"); // set the default cascade
...
void IrisCompare::loadVideoFile()
{
...
//Align the left and right eye position using pupil information and then extract the eye region
void IrisCompare::alignExractEyeImage(IplImage* currentLeftPairImg, IplImage* currentRightPairImg,
