...
#ifndef IRIS_COMPARE_H
#define IRIS_COMPARE_H

#include <QAction>

#include "ui_IrisCompare.h"
 ...
 * Main controller.
 */
class IrisCompare : public QMainWindow, protected Ui_IrisCompare
{
	Q_OBJECT
public:
    ...
    IrisCompare(QWidget* parent = 0, Qt::WindowFlags flags = 0);
    virtual ~IrisCompare();
